...
func TestReduceOp_log_sum_exp_default_axes_keepdims_example(t *testing.T) {
	assert := assert.New(t)

	onnxTest := basedir + "test_data/test_reduce_log_sum_exp_default_axes_keepdims_example/"
