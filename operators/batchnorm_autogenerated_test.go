...
// TestBatchnorm_epsilon is autogenerated from test_batchnorm_epsilon
func TestBatchnorm_epsilon(t *testing.T) {
	...
	attribute0Name := "epsilon"
	attribute0Type := onnx.AttributeProto_AttributeType(1)
	attribute0Value := float32(0.01)
...
// TestBatchnorm_example is autogenerated from test_batchnorm_example
func TestBatchnorm_example(t *testing.T) {
	debug := os.Getenv("SKIP_NOT_IMPLEMENTED")
	skip := true
	if debug == "false" {
		skip = false
